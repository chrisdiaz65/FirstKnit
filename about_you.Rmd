...
### my answer     
  I attended and graduated from John H. Francis Polytechnic high school. English and math were literally like two separate languages at times, although i much prefer English to math. I excelled in English in contrast to any other class.
...
### my answer   
  I have a Mac laptop at home, and i say I'm at a 4 when it comes to using and understanding it. My internet connection is also relatively stable.
...
### my answer     
   ...
   My name is Christopher, but almost everyone calls me Chris and that would suffice.
...
### my answer     
  I want to own a barbershop in my lifetime, currently I'm heavily interested in nursing. A degree in nursing is my goal for the foreseeable future. 
...
### my answer     
  I have only ever been to mexico. I would also love to go to Italy.I have not served in the military but if i were to get drafted i would join the marines as it's the most challenging and will instill great lifelong habits. 
...
### my answer     
  I have only ever taken math 115 which I'm currently enrolled in. I wasn't aware that only math 116 allows for certain transfer plans. I believe at least a C would allow me to continue with my plans to obtain a bachelors in nursing.
